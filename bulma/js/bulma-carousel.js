    ...
    return (function (i) {
        ...
        function (t, e, i) {
            ...
            var n =
                ...
                o = function (t) {
                    return (
                        ("function" == typeof t || ("object" === (void 0 === t ? "undefined" : n(t)) && !!t)) &&
                        !Array.isArray(t)
                    );
                };
        },
                    ...
                    n(e, [
                            ...
                            value: function (t, e) {
                                ...
                                return (
                                    ...
                                    function () {
                                        return i.events.set(
                                            t,
                                            i.events.get(t).filter(function (t) {
                                                return t !== e;
                                            })
                                        );
                                    }
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                return (
                                    this.events.has(t) &&
                                    this.events.get(t).map(function (t) {
        ...
        function (t, e, i) {
            ...
            var o = (function (t) {
                function o(t) {
                    ...
                    if (((r.element = Object(a.c)(t) ? document.querySelector(t) : t), !r.element))
                        throw new Error("An invalid selector or non-DOM node has been provided.");
                    r._clickEvents = ["click", "touch"];
                    var i = r.element.dataset
                        ? Object.keys(r.element.dataset)
                              .filter(function (t) {
                    ...
                    w(
                        ...
                        [
                                ...
                                value: function () {
                                    ...
                                    this.options.vertical
                                        ? ((this._ui.wrapper.style.height =
                                              Object(s.c)(this._slides[0]) * this.slidesToShow),
                                        ...
                                        this.options.vertical
                                            ? ((this._slideWidth = Math.ceil(this._wrapperWidth)),
                                              (this._containerHeight = Math.ceil(
                                                  Object(s.c)(this._slides[0]) * this._slides.length
                                              )),
                            ...
                            },
                            {
                                key: "_setHeight",
                                value: function () {
                                    "translate" !== this.options.effect &&
                                        (this._ui.container.style.height =
                                            Object(s.c)(this._slides[this.state.index]) + "px");
                                },
                            },
                            {
                                key: "_setClasses",
                                value: function () {
                                    ...
                                    this._slides.forEach(function (t) {
                                        Object(s.d)(t, "is-active is-current is-slide-previous is-slide-next"),
                                            Math.abs((e.state.index - 1) % e.state.length) ===
                                                parseInt(t.dataset.sliderIndex, 10) &&
                                                t.classList.add("is-slide-previous"),
                                            Math.abs(e.state.index % e.state.length) ===
                                                parseInt(t.dataset.sliderIndex, 10) && t.classList.add("is-current"),
                                            Math.abs((e.state.index + 1) % e.state.length) ===
                            ...
                            },
                            {
                                key: "previous",
                                value: function () {
                                    this.options.loop || this.options.infinite || 0 !== this.state.index
                                        ? (this.state.next = this.state.index - this.slidesToScroll)
                                        : (this.state.next = this.state.index),
                                        this.show();
                                },
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    !this.state.length ||
                                        ...
                                        ("Number" == typeof t && (this.state.next = t),
                            ...
                            },
                            {
                                key: "slidesToScroll",
                                get: function () {
                                    return "translate" === this.options.effect
                            ...
                            },
                            {
                                key: "direction",
                                get: function () {
                                    return "rtl" === this.element.dir.toLowerCase() ||
                            ...
                            value: function () {
                                document.addEventListener("visibilitychange", this.onVisibilityChange),
                                    this.slider.options.pauseOnHover &&
                                        (this.slider.container.addEventListener(s.a, this.onMouseEnter),
                                ...
                                this.stop(),
                                    this.slider.options.autoplay &&
                                        ...
                                        (this._interval = setInterval(function () {
                                            (t._hovering && t.slider.options.pauseOnHover) ||
                                                (!t.slider.options.centerMode &&
                                                t.slider.state.next >= t.slider.state.length - t.slider.slidesToShow &&
                                                !t.slider.options.loop &&
                                                !t.slider.options.infinite
                                                    ? t.stop()
                                                    : t.slider.next());
        ...
        function (t, e, i) {
            ...
            window.navigator.pointerEnabled || window.navigator.msPointerEnabled,
                (window.navigator.msPointerEnabled && 1 < window.navigator.msMaxTouchPoints) ||
                        ...
                        n(e, [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    try {
                                        for (
                                            var n, s = this.options.breakpoints[Symbol.iterator]();
                                            !(t = (n = s.next()).done);
                                            t = !0
                                        ) {
                                            var r = n.value;
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    this.slider.state.index >= this.slider.state.length &&
                                        0 !== this.slider.state.index &&
                                        (this.slider.state.index =
                                            this.slider.state.index - this._currentBreakpoint.slidesToScroll),
                                        this.slider.state.length <= this._currentBreakpoint.slidesToShow &&
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    e.slidesToShow !== this._currentBreakpoint.slidesToShow &&
                                        ((this._currentBreakpoint = e), this.apply());
                                },
                            },
                        ]),
                        e
                    ...
                    n(e, [
                        {
                            ...
                            value: function () {
                                if (this.slider.options.infinite && "translate" === this.slider.options.effect) {
                                    ...
                                    for (
                                        var t = [], e = 0, i = this.slider.state.length;
                                        i > this.slider.state.length - 1 - this._infiniteCount;
                                        i -= 1
                                    )
                                        (e = i - 1),
                                            t.unshift(
                                                this._cloneSlide(this.slider.slides[e], e - this.slider.state.length)
                                            );
                                    for (var n = [], s = 0; s < this._infiniteCount + this.slider.state.length; s += 1)
                                        n.push(
                                            this._cloneSlide(
                                                this.slider.slides[s % this.slider.state.length],
                                ...
                                this.slider.options.loop &&
                                    (0 < this.slider.state.next
                                        ? this.slider.state.next < this.slider.state.length
                                            ...
                                            : (this.slider.state.next = 0)
                                        : this.slider.state.next <= 0 - this.slider.slidesToScroll
                                          ? (this.slider.state.next =
                                                this.slider.state.length - this.slider.slidesToShow)
                                          : (this.slider.state.next = 0));
                            },
                    ...
                    r(e, [
                        {
                            ...
                            value: function () {
                                return (
                                    (this.node = document
                                        .createRange()
                                        .createContextualFragment(Object(n.a)(this.slider.options.icons))),
                                    (this._ui = {
                            ...
                            value: function (t) {
                                this.slider.options.keyNavigation &&
                                    ("ArrowRight" === t.key || "Right" === t.key
                                        ? this.slider.next()
                                        : ("ArrowLeft" !== t.key && "Left" !== t.key) || this.slider.previous());
                            },
                        },
                        {
                            key: "refresh",
                    ...
                    o(e, [
                            ...
                            value: function () {
                                if (
                                    ...
                                    for (var t = 0; t <= this._count; t++) {
                                        var e = document
                                            .createRange()
                                            .createContextualFragment(Object(s.a)()).firstChild;
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e = this,
                                    t = void 0;
                                (t = this.slider.options.infinite
                                    ? Math.ceil(this.slider.state.length - 1 / this.slider.slidesToScroll)
                                    : Math.ceil(
                                          (this.slider.state.length - this.slider.slidesToShow) /
                                              this.slider.slidesToScroll
                                      )) !== this._count && ((this._count = t), this._draw()),
                                    this._pages.forEach(function (t) {
                                        t.classList.remove("is-active"),
                                            parseInt(t.dataset.index, 10) ===
                                                e.slider.state.next % e.slider.state.length &&
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                if (this._origin) {
                                    ...
                                    (this._lastTranslate = new n.a(
                                        e.screenX - this._origin.x,
                                        e.screenY - this._origin.y
                                    )),
                                        t.touches &&
                                            Math.abs(this._lastTranslate.x) > Math.abs(this._lastTranslate.y) &&
                                            (this._supportsPassive || t.preventDefault(), t.stopPropagation());
                                }
                            },
                        },
                        {
                            ...
                            value: function (t, e) {
                                if (!this._animating || t) {
                                    ...
                                    (this._animationCallback = e),
                                        t
                                            ? this._animation && this._animation.disable()
                                            : (this._animation && this._animation.enable(), (this._animating = !0)),
                            ...
                            value: function () {
                                ...
                                return (
                                    "fade" === this.options.effect &&
                                        this.slider.slides.forEach(function (t, e) {
                                            Object(s.a)(t, {
                                                position: "absolute",
                                                left: 0,
                                                top: 0,
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                (this._oldSlide = this.slider.slides.filter(function (t) {
                                    ...
                                    this._oldSlide &&
                                        this._newSlide &&
                                        (Object(s.a)(this._oldSlide, { opacity: 0 }),
                                        Object(s.a)(this._newSlide, { opacity: 1, "z-index": t ? 0 : -1 }));
                            },
                        },
                        {
                            key: "onTransitionEnd",
                            value: function (t) {
                                "fade" === this.options.effect &&
                                    (this.transitioner.isAnimating() &&
                                        t.target == this._newSlide &&
                                        (this._newSlide &&
                                            (Object(s.a)(this._newSlide, { "z-index": 0 }),
                                            this._newSlide.removeEventListener(
                                                "transitionend",
                                                this.onTransitionEnd.bind(this)
                                            )),
                                        this._oldSlide &&
                                            (Object(s.a)(this._oldSlide, { "z-index": -2 }),
                                            this._oldSlide.removeEventListener(
                                                "transitionend",
                                                this.onTransitionEnd.bind(this)
                                            ))),
                    ...
                    a(n, [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if ("translate" === this.options.effect) {
                                    ...
                                    t = this.options.centerMode
                                        ? new r.a(
                                              Math.round(Object(o.e)(this.slider.container)),
                                              Math.round(Object(o.b)(this.slider.container))
                                          )
                                        : new r.a(
                                              Math.round(
                                                  Object(o.e)(this.slider.container) - Object(o.e)(this.slider.wrapper)
                                              ),
                                              Math.round(
                                                  Object(o.b)(this.slider.container) - Object(o.b)(this.slider.wrapper)
                                              )
                                          );
                                    var s = new r.a(
                                        Math.min(Math.max(-1 * n.x, -1 * t.x), 0),
                                        Math.min(Math.max(-1 * n.y, -1 * t.y), 0)
                                    );
                                    this.options.loop &&
                                        (!this.options.vertical && Math.abs(this._position.x) > t.x
                                            ? ((s.x = 0), (this.slider.state.next = 0))
                                            : this.options.vertical &&
                                              Math.abs(this._position.y) > t.y &&
                                              ((s.y = 0), (this.slider.state.next = 0))),
                                        (this._position.x = s.x),
                                        (this._position.y = s.y),
                                        this.options.centerMode &&
                                            (this._position.x =
                                                this._position.x + this.slider.wrapperWidth / 2 - Object(o.e)(i) / 2),
                                        "rtl" === this.slider.direction &&
                                            ((this._position.x = -this._position.x),
                                            (this._position.y = -this._position.y)),
                                        (this.slider.container.style.transform =
                                            "translate3d(" + this._position.x + "px, " + this._position.y + "px, 0)"),
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                "translate" === this.options.effect &&
                                    (this.transitioner.isAnimating() &&
                                        t.target == this.slider.container &&
                                        this.options.infinite &&
                                        this.slider._infinite.onTransitionEnd(t),
                                    this.transitioner.end());
                            },
                        },
                    ]),
